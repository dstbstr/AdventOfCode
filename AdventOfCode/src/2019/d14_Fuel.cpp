...
SOLUTION(2019, 14) {
    ...
    TEST(3) {
        ...
        return SolvePartOne(lines) == 13312;
    }
    ...
    TEST(4) {
        ...
        return SolvePartTwo(lines) == 82892753;
    }
    ...
    TEST(5) {
        ...
        return SolvePartOne(lines) == 180697;
    }
    TEST(6) {
        std::vector<std::string> lines = {
            "2 VPVL, 7 FWMGM, 2 CXFTF, 11 MNCFX => 1 STKFG",
        ...
        return SolvePartTwo(lines) == 5586022;
    }
    ...
    TEST(7) {
        ...
        return SolvePartOne(lines) == 2210736;
    }
    ...
    TEST(8) {
        ...
        return SolvePartTwo(lines) == 460664;
    }
}